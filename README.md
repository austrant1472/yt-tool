...
script kullanım kolaylığı için parametreleri kategorilere ayırır istediğiniz parametreleri birleştirerek kullanabilirsiniz
 video indirme
    ...
    -sound-m4a     : sadece sesi çeker (AAC 96k/m4a) formatında kaydeder
    -sound-opus    : sadece sesi çeker (64k VBR/opus) formatında kaydeder

anlık oynatma (oynatıcı: ffplay)

    -play          : videoyu indirmeden oynatır
    -loop          : videoyu döngü ile açar
    -sound         : sadece sesi oynatır (video penceresi arka planda açılır)
    -video         : sadece görüntüyü oynatır (Ses gelmez)
    -vol <0-100>   : oynatma modunda başlangıç ses seviyesini belirler mesela -vol 40 (varsayılan 30)
